...
function userPostService(req: any) {
...
function lastPostService(req: any) {
    return new Promise(async (resolve, reject) => {
        try {
...
function getPostService(req: any) {
    return new Promise(async (resolve, reject) => {
        try {
...
function createPostService(req: any) {
    return new Promise(async(resolve, reject) => {
        try {
...
function createReviewService(req: any) {
    return new Promise(async (resolve, reject) => {
        try {
...
function getReviewService(req: any) {
    return new Promise(async(resolve, reject) => {
        try {
